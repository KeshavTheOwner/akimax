...
API_ID = int(environ.get('API_ID', '26004388'))
API_HASH = environ.get('API_HASH', 'cb7ae56dc5577b8fcda0d0d05a40e3d8')
BOT_TOKEN = environ.get('BOT_TOKEN', '')
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '8211449985 6859451629').split()]
USERNAME = environ.get('USERNAME', "https://telegram.me/KeshavTheOwner")
...
QR_CODE = environ.get('QR_CODE', 'https://ibb.co/4RY9SqK4')
START_IMG = environ.get('START_IMG', 'https://envs.sh/uM5.jpg')
FSUB_PICS = (environ.get('FSUB_PICS', 'https://i.ibb.co/ZNC1Hnb/ad3f2c88a8f2.jpg')).split() 
...
FILES_DATABASE_URL = environ.get('FILES_DATABASE_URL', "mongodb+srv://golumandal369:rItvgZ1JeeOdn2to@cluster0.ecbu48o.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0") # For Files
SECOND_FILES_DATABASE_URL = environ.get('SECOND_FILES_DATABASE_URL', "mongodb+srv://devic5348:devic5348@cluster0.sczi6ga.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0") # 2nd DB For Files
...
LOG_API_CHANNEL = int(environ.get('LOG_API_CHANNEL', '-1002939065390'))
TUTORIAL = environ.get("TUTORIAL", "https://t.me/Themoviesnexustutorial/11")
TUTORIAL2 = environ.get("TUTORIAL2", "https://t.me/Themoviesnexustutorial/12")
TUTORIAL3 = environ.get("TUTORIAL3", "https://t.me/Themoviesnexustutorial/11")
...
SHORTENER_API2 = environ.get("SHORTENER_API2", "3f69d82334c1797bd2a7a80018a370d86d5dcc96")
SHORTENER_WEBSITE2 = environ.get("SHORTENER_WEBSITE2", 'seturl.in')
SHORTENER_API3 = environ.get("SHORTENER_API3", "f64c396e2eecef292e59c04bf38fbf20037605a9")
...
SUPPORT_GROUP = int(environ.get('SUPPORT_GROUP', '-1002872983818'))
...
MOVIE_UPDATE_CHANNEL = int(environ.get('MOVIE_UPDATE_CHANNEL', '-1003074425574'))  # Notification of sent to your channel
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002908843106 -1002372764752 -1003650011289 -1003576972912').split()] # Auto Index Channel
DELETE_CHANNELS = int(environ.get('DELETE_CHANNELS','-1002939065390')) # Channel to delete file from DB
...
BIN_CHANNEL = environ.get("BIN_CHANNEL", "-1002939065390") # Channel Where Files sent For stream
